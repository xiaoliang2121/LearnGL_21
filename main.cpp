...
void SetupRC()
    ...
    pBytes = gltLoadTGA("../LearnGL_21/Res/body.tga", &iWidth, &iHeight, &iComponents, &eFormat);
    ...
    pBytes = gltLoadTGA("../LearnGL_21/Res/glass.tga", &iWidth, &iHeight, &iComponents, &eFormat);
    glTexImage2D(GL_TEXTURE_2D, 0, iComponents, iWidth, iHeight, 0, eFormat, GL_UNSIGNED_BYTE, (void *)pBytes);
    free(pBytes);
